...
public class RobotBuilder {
    ...
    public Creature build() {
        switch (this.type) {
            case TANK:
                return new Creature(Creature.Type.TANK, Creature.Faction.ROBOT, 3, 4, false, new Vector<>(Arrays.asList(Ability.PUNCH, Ability.GRENADE)));
            case CANNON:
